            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand ms-4" href="index.html">
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{ url('assets/images/logo-light-text.png') }}" alt="homepage"
                                class="dark-logo" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav me-auto mt-md-0 ">
                        ...
                        <!-- Search -->
                        <!-- ============================================================== -->
                        <span style="font-size:30px;cursor:pointer;color:#fff; margin-top:10px;" id="myMenu" onclick="openNav()">&#9776;</span>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="#"><span class="fa fa-cog"></span> Settings</a></li>
                                <li><a class="dropdown-item" href="#"><span class="fa fa-power-off"></span> Logout</a></a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <div id="scroll-sidebar" class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a
                                class="{{ $selected_sub_menu == 'admin_petrol_pumps' ? 'active' : '' }} sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('admin.pumps.index') }}" aria-expanded="false">
                                <i class="mdi me-2 mdi-gas-station"></i><span class="hide-menu">Pumps</span></a>
                        </li>
                    </ul>
            ...
            <div id="sidebar-footer" class="sidebar-footer">
                <div class="row">
                    <div class="col-4 link-wrap">
                        <!-- item-->
                        <a id="perma-link" href="" class="link" data-toggle="tooltip" title=""
                            data-original-title="Settings"><i class="ti-settings"></i></a>
                    </div>
                    <div class="col-4 link-wrap">
                        <!-- item-->
                        <a id="link-1" href="" class="link" data-toggle="tooltip" title=""
                            data-original-title="Email"><i class="mdi mdi-gmail"></i></a>
                    </div>
                    <div class="col-4 link-wrap">
                        <!-- item-->
                        <a id="link-2" href="" class="link" data-toggle="tooltip" title=""
