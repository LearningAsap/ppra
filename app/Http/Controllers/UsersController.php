...
{
    protected $page_title = "Hospital Management System | Users";
	...
	public function index(){
        ...
        $this->page_title = "Hospital Management System | User Login";
    ...
    public function forgetpassword(){
        $this->page_title = "Hospital Management System | Forget Password";
    ...
    public function resetpassword($email){
        $this->page_title = "Hospital Management System | Reset Password";
    ...
    public function register(){
        ...
        $this->page_title = "Hospital Management System | Register User";
    ...
    public function permissiondenied(){
        $this->page_title = "Hospital Management System | Permission Denied";
